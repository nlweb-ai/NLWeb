...
class ItemDetailsHandler:
    ...
    async def _evaluate_item_match(self, item: dict[str, Any], details_requested: str) -> dict[str, Any] | None:
        ...
        try:
            ...
            response = await ask_llm(prompt, ans_struc, level="high", query_params=self.handler.query_params, max_length=4096)
            ...
            return {"score": 0, "explanation": f"Error: {e!s}"}
