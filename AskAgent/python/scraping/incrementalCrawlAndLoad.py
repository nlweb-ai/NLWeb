...
from .extractMarkup import extract_canonical_url, extract_schema_markup
...
class IncrementalCrawler:
    ...
    def __init__(self, domain: str, output_dir: str, db_name: str, max_retries: int = 3, database: str | None = None, reprocess_mode: bool = False):
        self.domain = domain
    ...
    def _extract_schema_types(self, schema_obj):
        ...
        if isinstance(schema_obj, dict):
            ...
            for _key, value in schema_obj.items():
    ...
    async def _fetch_page(self, url: str) -> tuple[str, int] | None:
    ...
    def _html_file_exists(self, url: str) -> tuple[bool, str | None]:
