...
class ElasticsearchEmbedding:
    ...
    def _initialize_client(self, endpoint:str, api_key:str)-> AsyncElasticsearch:
        ...
        try:
            ...
            logger.exception(f"Failed to initialize Elasticsearch embedding client: {e!s}")
            raise
    ...
    async def get_model_task_type(self)-> str:
        ...
        try:
            ...
            try:
                ...
                logger.exception(f"Failed to create the inference endpoint {self._model}: {e!s}")
                raise
        try:
            ...
            raise ValueError("Invalid response format from Elasticsearch inference endpoint") from e
    ...
    async def get_embeddings(
        ...
        try:
            ...
            logger.exception(f"Failed to get embeddings for text: {e!s}")
            raise
    ...
    async def get_batch_embeddings(
        ...
        try:
            ...
            logger.exception(f"Failed to get batch embeddings: {e!s}")
            raise
