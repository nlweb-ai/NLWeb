...
class OpenSearchClient(RetrievalClientBase):
    ...
    async def create_index_if_not_exists(self, index_name: str | None = None,
        ...
        try:
            ...
            if hasattr(e, 'response') and hasattr(e.response, 'text'):
                error_details = f"{e!s} - Response: {e.response.text}"
    ...
    async def recreate_index(self, index_name: str | None = None,
                           vector_dimension: int = 1536) -> bool:
        """
    ...
    async def search(self, query: str, site: Union[str, list[str]],
        ...
        try:
            ...
            logger.exception("Error in OpenSearch")
            logger.log_with_context(
                LogLevel.ERROR,
    ...
    async def _search_by_site_and_vector(self, sites: Union[str, list[str]],
        ...
        try:
            ...
            logger.exception("Error in _search_by_site_and_vector")
            logger.log_with_context(
                LogLevel.ERROR,
                "OpenSearch retrieval failed",
                {
    ...
    async def search_all_sites(self, query: str, top_n: int = 10,
                             index_name: str | None = None, query_params: dict[str, Any] | None = None, **kwargs) -> list[list[str]]:
        """
