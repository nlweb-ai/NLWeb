...
class AzureSearchClient(RetrievalClientBase):
    ...
    def _get_search_client(self, index_name: str | None = None) -> SearchClient:
        """
    ...
    def ensure_index_exists(self, index_name: str | None = None,
                          embedding_size: int = 1536) -> bool:
        """
    ...
    def drop_index(self, index_name: str | None = None) -> bool:
        """
    ...
    async def delete_documents_by_site(self, site_value: str,
        ...
        try:
            ...
            logger.error(f"Error deleting documents for site {site_value}: {e!s}")
            return 0
    ...
    async def upload_documents(self, documents: list[dict[str, Any]],
        ...
        try:
            ...
            logger.error(f"Error uploading documents to index '{index_name}': {e!s}")
            return 0

    async def search(self, query: str, site: Union[str, list[str]],
                   num_results: int = 50, index_name: str | None = None,
    ...
    async def _retrieve_by_site_and_vector(self, sites: Union[str, list[str]],
                                         ...
                                         top_n: int = 10,
                                         index_name: str | None = None) -> list[list[str]]:
        """
        ...
        try:
            ...
            logger.exception("Error in _retrieve_by_site_and_vector")
    ...
    async def search_by_url(self, url: str, index_name: str | None = None,
                          top_n: int = 1) -> list[str] | None:
        """
    ...
    async def search_all_sites(self, query: str, num_results: int = 50,
        ...
        try:
            ...
            logger.exception("Error in search_all_sites")
            logger.log_with_context(
                LogLevel.ERROR,
    ...
    async def get_sites(self, index_name: str | None = None) -> list[str]:
        """
