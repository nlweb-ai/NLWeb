...
class StorageProvider(ABC):
    ...
    @abstractmethod
    async def add_conversation(self, user_id: str, site: str, message_id: str | None,
    ...
    @abstractmethod
    async def get_conversation_by_id(self, conversation_id: str, limit: int | None = None) -> list[dict[str, Any]]:
        """
...
async def add_conversation(user_id: str, site: str, message_id: str | None,
                         user_prompt: str, response: str, conversation_id: str,
                         embedding: list[float] | None = None,
                         summary: str | None = None, main_topics: list[str] | None = None,
                         participants: list[dict[str, Any]] | None = None) -> ConversationEntry:
...
async def get_conversation_by_id(conversation_id: str, limit: int | None = None) -> list[dict[str, Any]]:
    """
