...
def remove_duplicates(input_file: str, output_file: str | None = None) -> None:
    """
    Remove duplicate URLs from JSONL file.
    ...
    with open(input_path) as infile, open(output_file, 'w') as outfile:
