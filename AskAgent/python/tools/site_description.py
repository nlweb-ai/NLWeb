...
class ShopifyDescriptionGenerator:
    ...
    def __init__(self, input_file: str, output_file: str, llm_provider: str | None = None):
...
- Keep extremely compact"""
        ...
        if len(prompt) > 10000:
            print("    WARNING: Prompt is very long! First 500 chars:")
            print(f"    {prompt[:500]}...")
...
def main():
    ...
    from core.llm import get_available_providers
    from core.llm import init as llm_init
    llm_init()
