...
async def oauth_token_handler(request: web.Request) -> web.Response:
    ...
    try:
        ...
        async with aiohttp.ClientSession() as session:
            ...
            elif provider == 'microsoft' or provider == 'facebook':
                token_data['grant_type'] = 'authorization_code'
...
async def get_user_info(session: aiohttp.ClientSession, provider: str, access_token: str, provider_config: dict[str, Any]) -> dict[str, Any] | None:
