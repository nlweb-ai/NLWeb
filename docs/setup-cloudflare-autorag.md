...
Edit [config_retrieval.yaml](../config/config_retrieval.yaml) and change `write_endpoint` at the top to `write_endpoint: cloudflare_autorag`. Then, in your `.env` file, set the following variables:
